"""
Django settings for projeto_process project.
...
SECRET_KEY = 'django-insecure--b!-y4r*5xl#xr(5n#nhs$i5x^g#hvbda-34f4^1e$l_j8in%5'
...
DATETIME_INPUT_FORMATS = ( "%d-%m-%Y %H:%M", )  #'03/04/2024'
